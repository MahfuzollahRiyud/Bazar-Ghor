...
export default function BlogCreate({ existingCategories }: Props) {
    ...
    const [authorName, setAuthorName] = useState('Bazar Ghor Team');
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post('/dashboard/blogs', formData, {
            forceFormData: true,
            onError: (errs) => {
                setErrors(errs);
                setSubmitting(false);
            ...
            onSuccess: () => {
                toast.success(language === 'bn' ? 'ব্লগ পোস্ট সফলভাবে তৈরি হয়েছে!' : 'Blog post published successfully!');
            },
    ...
    return (
        <>
            <Head title={language === 'bn' ? 'নতুন ব্লগ পোস্ট — Bazar Ghor Admin' : 'Write Blog Post — Bazar Ghor Admin'} />
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="rounded-2xl border border-gray-200/80 bg-white p-5 shadow-xs space-y-4">
                                <h3 className="font-semibold text-gray-900 text-base flex items-center gap-2">
                                    ...
                                    <span>{language === 'bn' ? 'আর্টিকেল বিস্তারিত' : 'Article Details'}</span>
                                </h3>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder={language === 'bn' ? 'উদাহরণ: সেরা ৫টি ব্লুটুথ এয়ারবাডস ২০২৬' : 'e.g., Best 5 Wireless Earbuds in Bangladesh 2026'}
                                    ...
                                    <div className="flex items-center justify-between mb-1">
                                        ...
                                        <label className="flex items-center gap-1.5 text-xs text-gray-500 cursor-pointer">
                                            <input
                                                ...
                                                className="rounded border-gray-300 text-[#2d6a27] focus:ring-[#2d6a27]"
                                            />
                                            <span>{language === 'bn' ? 'অটো-স্লাগ' : 'Auto generate'}</span>
                                        </label>
                                    </div>
                            ...
                            <div className="rounded-2xl border border-gray-200/80 bg-white p-5 shadow-xs space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder={title || 'SEO Title for Google search snippet'}
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder={excerpt || 'Meta description shown in Google search results...'}
                                        className="w-full rounded-xl border border-gray-200 bg-gray-50/50 p-3 text-sm text-gray-900 focus:border-[#2d6a27] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2d6a27]/20"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-gray-200/80 bg-white p-5 shadow-xs space-y-4">
                                ...
                                >
                                    {submitting ? (
                                        ...
                                        <>
                                            <Check size={16} />
                                            <span>{isPublished ? (language === 'bn' ? 'পোস্ট পাবলিশ করুন' : 'Publish Article') : (language === 'bn' ? 'ড্রাফট হিসেবে সংরক্ষণ' : 'Save as Draft')}</span>
                                        </>
                                    )}
                                </button>
                            </div>
